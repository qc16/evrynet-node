...
type Clique struct {
	...
	db     evrdb.Database       // Database to store and retrieve snapshot checkpoints
...
func New(config *params.CliqueConfig, db evrdb.Database) *Clique {
...
// rewards given.
func (c *Clique) Finalize(chain consensus.FullChainReader, header *types.Header, state *state.StateDB, txs []*types.Transaction, uncles []*types.Header) error {
