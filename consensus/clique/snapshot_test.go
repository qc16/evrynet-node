...
// mapped from textual names used in the tests below to actual Evrynet private
...
// address retrieves the Evrynet address of a tester account by label, creating
...
func (ap *testerAccountPool) address(account string) common.Address {
	...
	// Resolve and return the Evrynet address
...
func TestClique(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			// batch (https://github.com/Evrynetlabs/evrynet-node/issues/17593). Whilst this
