...
import (
	...
	"github.com/evrynet-official/evrynet-client/internal/build"
)
...
func TestAndroid(t *testing.T) {
	...
	gobind := exec.Command("gomobile", "bind", "-javapkg", "org.ethereum", "github.com/evrynet-official/evrynet-client/mobile")
