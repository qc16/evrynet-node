...
func makeHeaderChain(parent *types.Header, n int, db evrdb.Database, seed int) []*types.Header {
...
// header only chain.
func newCanonical(n int) (evrdb.Database, *LightChain, error) {
...
func (odr *dummyOdr) Database() evrdb.Database {
	return odr.db
}
