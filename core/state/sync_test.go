...
// account array.
func checkStateAccounts(t *testing.T, db evrdb.Database, root common.Hash, accounts []*testAccount) {
...
func checkTrieConsistency(db evrdb.Database, root common.Hash) error {
...
func checkStateConsistency(db evrdb.Database, root common.Hash) error {
...
func TestIncompleteStateSync(t *testing.T) {
	...
	checkTrieConsistency(srcDb.TrieDB().DiskDB().(evrdb.Database), srcRoot)
