...
func NewDatabase(db evrdb.KeyValueStore) evrdb.Database {
	return &nofreezedb{
		KeyValueStore: db,
	}
}
...
// storage.
func NewDatabaseWithFreezer(db evrdb.KeyValueStore, freezer string, namespace string) (evrdb.Database, error) {
...
func NewMemoryDatabase() evrdb.Database {
...
func NewMemoryDatabaseWithCap(size int) evrdb.Database {
	return NewDatabase(memorydb.NewWithCap(size))
}

// NewLevelDBDatabase creates a persistent key-value database without a freezer
// moving immutable chain segments into cold storage.
func NewLevelDBDatabase(file string, cache int, handles int, namespace string) (evrdb.Database, error) {
...
// freezer moving immutable chain segments into cold storage.
func NewLevelDBDatabaseWithFreezer(file string, cache int, handles int, freezer string, namespace string) (evrdb.Database, error) {
...
func InspectDatabase(db evrdb.Database) error {
	it := db.NewIterator()
	defer it.Release()
