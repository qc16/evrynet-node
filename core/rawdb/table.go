...
func NewTable(db evrdb.Database, prefix string) evrdb.Database {
	return &table{
		db:     db,
		prefix: prefix,
	}
...
func (t *table) NewIterator() evrdb.Iterator {
...
// not exist).
func (t *table) NewIteratorWithStart(start []byte) evrdb.Iterator {
	return t.db.NewIteratorWithStart(start)
}

// NewIteratorWithPrefix creates a binary-alphabetical iterator over a subset
// of database content with a particular key prefix.
func (t *table) NewIteratorWithPrefix(prefix []byte) evrdb.Iterator {
...
func (t *table) NewBatch() evrdb.Batch {
...
func (b *tableBatch) Replay(w evrdb.KeyValueWriter) error {
