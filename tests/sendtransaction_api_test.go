...
//TestSendTxCreateContractWithProviderAddress test send tx to create a contract with provider attached.
...
//	curl -H "Content-Type: application/json" -X POST --data '{"jsonrpc":"2.0","method":"eth_sendTransaction","params":[{"from":"0x7b9160548b27a5c14f8819eda719f955437862d5", "provider":"0x8359d8C955DAef81e171C13659bA3Fb0dDa144b4", "gas":"0xF4240", "data":""}],"id":1}' http://localhost:8545
func TestSendTxCreateContractWithProviderAddress(t *testing.T) {
	...
	assert.NoError(t, ethClient.SendTx(context.Background(), args))
}
