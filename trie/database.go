...
type Database struct {
	diskdb evrdb.KeyValueStore // Persistent storage for matured trie nodes
...
func NewDatabase(diskdb evrdb.KeyValueStore) *Database {
...
func NewDatabaseWithCache(diskdb evrdb.KeyValueStore, cache int) *Database {
...
func (db *Database) DiskDB() evrdb.KeyValueReader {
	return db.diskdb
}
...
func (db *Database) commit(hash common.Hash, batch evrdb.Batch, uncacher *cleaner) error {
